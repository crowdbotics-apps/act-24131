...
admin.site.site_header = "ActiveLab"
admin.site.site_title = "ActiveLab Admin Portal"
admin.site.index_title = "ActiveLab Admin"

# swagger
api_info = openapi.Info(
    title="Act API",
    default_version="v1",
    description="API documentation for Act App",
)
